...
PROTOBUF_NAMESPACE_OPEN
template <>
::communication::Command * Arena::CreateMaybeMessage<::communication::Command>(Arena *);
PROTOBUF_NAMESPACE_CLOSE
namespace communication
{
...
: public ::PROTOBUF_NAMESPACE_ID::
    Message /* @@protoc_insertion_point(class_definition:communication.Command) */
{
public:
...
private:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() { return "communication.Command"; }
...
// double thrust = 1;
inline void Command::clear_thrust() { thrust_ = 0; }
inline double Command::_internal_thrust() const { return thrust_; }
inline double Command::thrust() const
{
  // @@protoc_insertion_point(field_get:communication.Command.thrust)
  return _internal_thrust();
}
inline void Command::_internal_set_thrust(double value) { thrust_ = value; }
...
// bool emergency_stop = 2;
inline void Command::clear_emergency_stop() { emergency_stop_ = false; }
inline bool Command::_internal_emergency_stop() const { return emergency_stop_; }
...
inline void Command::_internal_set_emergency_stop(bool value) { emergency_stop_ = value; }
