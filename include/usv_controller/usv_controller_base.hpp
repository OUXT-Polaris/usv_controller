...
#ifndef USV_CONTROLLER__USV_CONTROLLER_BASE_HPP_
#define USV_CONTROLLER__USV_CONTROLLER_BASE_HPP_
...
protected:
  realtime_tools::RealtimeBuffer<std::shared_ptr<T>> rt_command_ptr_;
