...
: Node("usv_controller_node", options),
  ...
  left_thruster_publisher_(parameters_.thrusters.left.ip, parameters_.thrusters.left.port, 2000),
  right_thruster_publisher_(parameters_.thrusters.right.ip, parameters_.thrusters.right.port, 2001),
