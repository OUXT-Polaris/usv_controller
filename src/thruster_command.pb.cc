...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Command_thruster_5fcommand_2eproto = {
  {ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0,
   InitDefaultsscc_info_Command_thruster_5fcommand_2eproto},
  {}};
...
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const **
  file_level_enum_descriptors_thruster_5fcommand_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const **
  file_level_service_descriptors_thruster_5fcommand_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32
  TableStruct_thruster_5fcommand_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    ~0u,  // no _has_bits_
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message *>(
    &::communication::_Command_default_instance_),
};

const char descriptor_table_protodef_thruster_5fcommand_2eproto[] PROTOBUF_SECTION_VARIABLE(
  protodesc_cold) =
...
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable * const
  descriptor_table_thruster_5fcommand_2eproto_deps[1] = {};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase * const
  descriptor_table_thruster_5fcommand_2eproto_sccs[1] = {
    &scc_info_Command_thruster_5fcommand_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag
  descriptor_table_thruster_5fcommand_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable
  descriptor_table_thruster_5fcommand_2eproto = {
    false,
    false,
    descriptor_table_protodef_thruster_5fcommand_2eproto,
    "thruster_command.proto",
    98,
    &descriptor_table_thruster_5fcommand_2eproto_once,
    descriptor_table_thruster_5fcommand_2eproto_sccs,
    descriptor_table_thruster_5fcommand_2eproto_deps,
    1,
    0,
    schemas,
    file_default_instances,
    TableStruct_thruster_5fcommand_2eproto::offsets,
    file_level_metadata_thruster_5fcommand_2eproto,
    1,
    file_level_enum_descriptors_thruster_5fcommand_2eproto,
    file_level_service_descriptors_thruster_5fcommand_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_thruster_5fcommand_2eproto =
...
Command::Command(::PROTOBUF_NAMESPACE_ID::Arena * arena) : ::PROTOBUF_NAMESPACE_ID::Message(arena)
{
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:communication.Command)
}
Command::Command(const Command & from) : ::PROTOBUF_NAMESPACE_ID::Message()
{
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(
    &thrust_, &from.thrust_,
    static_cast<size_t>(
      reinterpret_cast<char *>(&emergency_stop_) - reinterpret_cast<char *>(&thrust_)) +
      sizeof(emergency_stop_));
...
void Command::SharedDtor() { GOOGLE_DCHECK(GetArena() == nullptr); }
...
void Command::SetCachedSize(int size) const { _cached_size_.Set(size); }
  ...
  ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream * stream) const
{
  ...
  if (this->emergency_stop() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteBoolToArray(
      2, this->_internal_emergency_stop(), target);
  }
...
void Command::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message & from)
{
  ...
  const Command * source = ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<Command>(&from);
  if (source == nullptr) {
...
bool Command::IsInitialized() const { return true; }
...
void Command::InternalSwap(Command * other)
{
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
    PROTOBUF_FIELD_OFFSET(Command, emergency_stop_) + sizeof(Command::emergency_stop_) -
    PROTOBUF_FIELD_OFFSET(Command, thrust_)>(
    reinterpret_cast<char *>(&thrust_), reinterpret_cast<char *>(&other->thrust_));
}

::PROTOBUF_NAMESPACE_ID::Metadata Command::GetMetadata() const { return GetMetadataStatic(); }

// @@protoc_insertion_point(namespace_scope)
}  // namespace communication
PROTOBUF_NAMESPACE_OPEN
template <>
PROTOBUF_NOINLINE ::communication::Command * Arena::CreateMaybeMessage<::communication::Command>(
  Arena * arena)
{
